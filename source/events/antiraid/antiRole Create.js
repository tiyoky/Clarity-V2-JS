...
module.exports = {
    ...
    run: async (client, role) => {
        ...
        const audit = await role.guild.fetchAuditLogs({type: 30, limit: 1}).then(a => a.entries.first())
        ...
        switch(db.antirole.sanction){
            ...
            case "warn": {
                const embed = new EmbedBuilder()
                    ...
                    .addFields({ name: "Raison", value: "Création de role"})
                ...
                warn.push({ reason: "Création de role", date: Date.now(), moderator: client.user.id });
